...
static mut CONFIG:HttpHeadersConfigurations  = HttpHeadersConfigurations {
    max_method_size:10,
    max_version_size:20,
...
/// getting the global config for Http Headers Configurations
pub fn global_config()->&'static HttpHeadersConfigurations {
...
pub  fn set_new_http_configurations(conf:HttpHeadersConfigurations){
    unsafe {CONFIG = conf}
}

/// defining important http parsing configurations
#[derive(Debug)]
pub struct HttpHeadersConfigurations {
...
impl HttpHeadersConfigurations {



    /// creating default http headers configurations
    pub fn default()->Self{
        Self {
            max_method_size:10,
            max_version_size:25,
